  ...
  return (
    <section className={rootClassName}>
      <Frame className={frameClassName}>
          <h2 className="w-1/2 lg:self-end text-white text-center lg:text-left text-6xl lg:text-8xl font-bold">
            Find the best <span className="text-primaryLight">talent</span>
          </h2>

          <div className="w-80 text-white text-lg flex flex-col before:hidden lg:before:block before:bg-secondaryBlue before:w-12 before:h-1 before:self-start before:mb-16">
